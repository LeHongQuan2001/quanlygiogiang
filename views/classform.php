  ...
  <form role="form" action="<?php echo WEB_ROOT; ?>views/process.php?cmd=createClass" method="post">
    <div class="box-body">
      <div class="form-group">
        ...
        <span id="sprytf_name">
		<input type="text" name="idMaLop" class="form-control input-sm" placeholder="Mã Lớp">
		</span>
      </div>
      <div class="form-group">
        <label for="exampleInputEmail1">Tên Lớp</label>
        <span id="sprytf_name">
		<input type="text" name="tenLop" class="form-control input-sm" placeholder="Tên Lớp">
		</span>
      </div>

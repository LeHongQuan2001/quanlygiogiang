...
if($action == "save_giaovu"){
	$save = $crud->save_giaovu();
	if($save)
		echo $save;
}
if($action == "delete_giaovu"){
	$save = $crud->delete_giaovu();
	if($save)
		echo $save;
}
...
if($action == "save_giaovien"){
	$save = $crud->save_giaovien();
	if($save)
		echo $save;
}
if($action == "delete_giaovien"){
	$save = $crud->delete_giaovien();
	if($save)
		echo $save;
}
if($action == "save_log"){
